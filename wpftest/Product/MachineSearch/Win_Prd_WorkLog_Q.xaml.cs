...
namespace WizMes_HanMin
{
    ...
    class Win_Prd_WorkLog_Q_CodeView : BaseView
    {
        ...
        //public string SumWorkQty { get; set; } //2021-08-12 검사수량 추가
        //public string DefectSpec { get; set; }  //2021-08-12 검사Spec 추가
        //public string InsGubun { get; set; }
        //public string InsValue { get; set; }
        //public string InsGongCha { get; set; }
