    ...
    public partial class Win_Qul_InspectAutoRepair_U : UserControl
    {
        ...
        private void FillGrid()
        {
            ...
            try
            {
                ...
                DataSet ds = DataStore.Instance.ProcedureToDataSet_LogWrite("xp_Inspect_sAutoInspectRepair", sqlParameter, true, "R");
                                ...
                                string CorrContents, string DefectRespectContents, string RepairYN)
        {
            ...
            try
            {
                ...
                string[] result = DataStore.Instance.ExecuteProcedure_NewLog("xp_Inspect_uAutoInspectRepair", sqlParameter, "D");
