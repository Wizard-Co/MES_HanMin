    ...
    public partial class Win_Qul_Drawing_U : UserControl
    {
        ...
        private void FillGrid()
        {
            try {
                ...
                DataSet ds = DataStore.Instance.ProcedureToDataSet_LogWrite("xp_dvlDraw_sDraw", sqlParameter, true, "R");
        ...
        private bool DeleteData(string strDrawID)
        {
            ...
            try {
                ...
                string[] result = DataStore.Instance.ExecuteProcedure_NewLog("xp_dvlDraw_dDraw", sqlParameter, "D");
