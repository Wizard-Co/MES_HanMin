...
namespace WizMes_HanMin
{
    ...
    public partial class Win_Qul_DateBox_Q : UserControl
    {
        ...
        private void FillGrid()
        {
            ...
            DataSet ds = DataStore.Instance.ProcedureToDataSet_LogWrite("xp_Inspect_sInspectByBox_20211014", sqlParameter, true, "R");
                    ...
                    try
                    {
                        ...
                        foreach (DataRow item in drc)
                        {
                            if (item["cls"].ToString() == "1")
                            {
                                ...
                                if ((Window_Ins_DateBox_ViewInsert.ExamDate != string.Empty) && (Window_Ins_DateBox_ViewInsert.ExamDate != null) && (lib.IsNullOrWhiteSpace(Window_Ins_DateBox_ViewInsert.ExamDate) != true))   
                                {
                                    Window_Ins_DateBox_ViewInsert.ExamDate = DateTime.ParseExact(Window_Ins_DateBox_ViewInsert.ExamDate, "yyyyMMdd", null).ToString("yyyy-MM-dd");
                                }
                                else { Window_Ins_DateBox_ViewInsert.ExamDate = string.Empty; }
        ...
        private void dtpSDate_SelectedDateChanged(object sender, SelectionChangedEventArgs e)
        {
            if (dtpFromDate.SelectedDate > dtpToDate.SelectedDate)
            {
                ...
                dtpFromDate.SelectedDate = Convert.ToDateTime(e.RemovedItems[0].ToString());
            }
